...
* Based on these metrics alone, sample 1 seems okay, so per Lisa's suggestion, will leave it in.
...
problem_sample_IDs <- c("3", "4", "6", "9", "10", "12", "15", "23", "13", "18", "24")
...
write.csv(male_res_outs, file = "output/QCfilt+1_M.HFHS_vs_M.Control_DESeq2.csv")
write.csv(female_res_outs, file = "output/QCfilt+1_F.HFHS_vs_F.Control_DESeq2.csv")
write.csv(all.HFHS_vs_all.Control_outs, file = "output/QCfilt+1_all.HFHS_vs_all.Control.csv")
write.csv(control_res_outs, file = "output/QCfilt+1_M.Control_vs_F.Control_DESeq2.csv")
```
...
write_csv(f.kegg_enrich@result, file = "output/QCfilt+1_F.HFHS_vs_F.Control_KEGGPathways.csv")
```
...
write_csv(m.kegg_enrich@result, file = "output/QCfilt+1_M.HFHS_vs_M.Control_KEGGPathways.csv")
```
...
write_csv(all.kegg_enrich@result, file = "output/QCfilt+1_ALL.HFHS_vs_ALL.Control_KEGGPathways.csv")
```
